          ...
          return SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  const Icon(Icons.calendar_month, size: 80, color: AppColors.iconSoft),
      ...
      case 3:
        ...
        return SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                const Icon(Icons.handshake, size: 80, color: AppColors.iconSoft),
                const SizedBox(height: 20),
                const Text(
